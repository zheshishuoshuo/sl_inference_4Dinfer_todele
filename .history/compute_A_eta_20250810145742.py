...
def compute_A_eta(n_samples=5000, ms_points=100, m_lim=26.5, lens_file="lens_samples.csv"):
    ...
    path = os.path.join(os.path.dirname(__file__), "A_eta_table_alpha_nonsel.csv")
