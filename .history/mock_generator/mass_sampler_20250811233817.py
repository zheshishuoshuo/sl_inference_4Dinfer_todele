...
# 源星等分布采样
# ==============================
def _sample_m_s(alpha_s, m_s_star, size=1, rng=None, m_min=20.0, m_max=30.0):
...
def sample_m_s(alpha_s, m_s_star, size=1, rng=None, m_min=20.0, m_max=30.0):
    return np.ones(size) * _sample_m_s(alpha_s, m_s_star, size=size, rng=rng, m_min=m_min, m_max=m_max)
